...
<body id="page-top" ng-controller="myController">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h5 mb-4 text-gray-800">BARANGAY NEWS & UPDATE</h1>
					<div class="col-lg-12">
						<a dir-paginate="news in news|itemsPerPage:5" style="color:inherit;" href="displayNews.php?news_id={{news.news_id}}">	
    ...
    <script>
		...
		app.controller('myController', function($scope, $http){
			$http.get('admin/newsData.php').then(function(response){
