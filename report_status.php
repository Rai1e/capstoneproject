...
<body id="page-top" ng-controller="myController">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<a dir-paginate="report in report|itemsPerPage:5" style="color:inherit;" href="status_view.php?report_no={{report.report_id}}">	
						<div class="card mt-1 mb-1">
							<div class="card-body">
								<small class="float-left">Ticket no: <br /><span class="text-primary">{{report.ticket_no}}</span></small>
								<small class="float-right">Status: <br /><span>{{report.status_report}}</span></small>
							</div>
						</div>
					</a>
    ...
    <script>
		...
		app.controller('myController', function($scope, $http){
			$http.get('reportData.php?user_id='+<?php echo $_SESSION['user_id']?>).then(function(response){
