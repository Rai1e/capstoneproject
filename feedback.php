        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<form method="POST" action="submitFeedback.php" enctype="multipart/form-data">
						...
						<div class="form-group mt-3">
							<label>Message</label>
							<textarea name="message" class="form-control" style="resize:none;" rows="10" required="required"></textarea>
						</div>
						<div class="form-group mt-5">
							<button type="submit" name="submit-feeback" class="btn btn-primary btn-block">Submit</button>
						</div>
					</form>
                </div>
                <!-- /.container-fluid -->
